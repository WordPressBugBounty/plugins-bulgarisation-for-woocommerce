...
exports.automat = exports.office = exports.address = undefined;
...
var _Office = __webpack_require__(335);
...
var automat = exports.automat = _vue2.default.extend({
	render: function render(h) {
		return h(_Office2.default, {
			props: {
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_import_glob_index_js_Address_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(183);
...
exports.default = {
	...
	methods: {
		...
		loadCity: function loadCity() {
			...
			_axios2.default.post(woocommerce_params.ajax_url, _qs2.default.stringify(data)).then(function (response) {
				...
				_this.addresses.forEach(function (address) {
					if (_this.selectedAddress.id == address.id && _this.selectedAddress.type == address.type && _this.selectedAddress.orig_key == address.orig_key) {
						selectedAddress = address;
						clearAdditionaFields = false;
					}
				});

				_this.selectedAddress = (0, _cloneDeep2.default)(selectedAddress);
		...
		setCookieData: function setCookieData() {
			...
			(0, _utils.setCookie)('woo-bg--econt-address', cookie, 1);
		},
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_import_glob_index_js_Office_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(185);
...
exports.default = {
	...
	computed: {
		officeLocatorUrl: function officeLocatorUrl() {
			var officeType = this.deliveryType === 'automat' ? 'aps' : 'office';
			var url = 'https://officelocator.econt.com/?city=' + this.city + '&officeType=' + officeType + '&shopUrl=' + window.location.href;
			var _this = this;
	...
	methods: {
		setOfficeFromLocator: function setOfficeFromLocator(message) {
			...
			var officeID = message.data.office.code;
		...
		initOfficeLocator: function initOfficeLocator() {
			$('#woo-bg--econt-office-locator').magnificPopup({
				...
				midClick: true,
				iframe: {
					markup: '<div class="mfp-iframe-scaler">' + '<div class="mfp-close"></div>' + '<iframe allow="geolocation;" style="border-width: 0px;" class="mfp-iframe"></iframe>' + '</div>'
				}
			});
		...
		loadLocalStorage: function loadLocalStorage() {
			var localStorageData = localStorage.getItem(this.getStorageKey());
			if (localStorageData) {
				localStorageData = JSON.parse(localStorageData);
...
var render = function render() {
  var _vm = this,
      _c = _vm._self._c;return _c('div', { staticClass: "woo-bg--econt-delivery" }, [_c('multiselect', { staticClass: "woo-bg-multiselect", attrs: { "id": "ajax", "placeholder": "", "deselect-label": "", "open-direction": "bottom", "track-by": "id", "label": "label", "options-limit": 30, "limit": 6, "max-height": 600, "close-on-select": _vm.closeOnSelect, "selectedLabel": _vm.i18n.selected, "selectLabel": _vm.i18n.select, "options": _vm.addresses, "loading": _vm.isLoading, "multiple": false, "searchable": true, "internal-search": false, "clear-on-select": false, "show-no-results": true }, on: { "search-change": _vm.asyncFind, "input": _vm.setAddress }, scopedSlots: _vm._u([{ key: "singleLabel", fn: function fn(_ref) {
        var option = _ref.option;
        return [_c('strong', [_vm._v(_vm._s(option.label))])];
      } }]), model: { value: _vm.selectedAddress, callback: function callback($$v) {
        _vm.selectedAddress = $$v;
      }, expression: "selectedAddress" } }, [_vm._v(" "), _c('span', { attrs: { "slot": "noResult" }, slot: "noResult" }, [_vm._v(_vm._s(_vm.i18n.noResult))]), _vm._v(" "), _c('span', { attrs: { "slot": "noOptions" }, slot: "noOptions" }, [_vm._v(_vm._s(_vm.i18n.noOptions))]), _vm._v(" "), _c('span', { attrs: { "slot": "placeholder" }, slot: "placeholder" }, [_vm._v(_vm._s(_vm.i18n.searchAddress))])]), _vm._v(" "), _vm.selectedAddress && _vm.selectedAddress.type && _vm.selectedAddress.type === 'streets' ? _c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.streetNumber, expression: "streetNumber" }], staticClass: "woo-bg-multiselect--additional-field input-text", attrs: { "placeholder": _vm.i18n.streetNumber, "type": "text" }, domProps: { "value": _vm.streetNumber }, on: { "keyup": _vm.streetNumberChanged, "input": function input($event) {
        if ($event.target.composing) return;_vm.streetNumber = $event.target.value;
      } } }) : _vm._e(), _vm._v(" "), _vm.selectedAddress && _vm.selectedAddress.type && _vm.selectedAddress.type === 'quarters' ? _c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.other, expression: "other" }], staticClass: "woo-bg-multiselect--additional-field input-text", attrs: { "placeholder": _vm.i18n.blVhEt, "type": "text" }, domProps: { "value": _vm.other }, on: { "keyup": _vm.streetNumberChanged, "input": function input($event) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(334);
/* harmony import */ var _Address_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(182);
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(
  ...
  _Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0__["render"],
  _Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
"use strict";
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(230);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (checked) */ if(__webpack_require__.o(_node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0__, "render")) __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0__, "staticRenderFns")) __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Address_vue_vue_type_template_id_6bbfbcc0__WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(336);
/* harmony import */ var _Office_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(184);
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(
  ...
  _Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0__["render"],
  _Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
"use strict";
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(231);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (checked) */ if(__webpack_require__.o(_node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0__, "render")) __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0__, "staticRenderFns")) __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_babel_loader_lib_index_js_ref_3_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Office_vue_vue_type_template_id_0df6210c__WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
