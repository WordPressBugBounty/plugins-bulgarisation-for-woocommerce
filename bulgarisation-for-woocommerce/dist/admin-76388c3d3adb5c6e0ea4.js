...
/******/ 		return __webpack_require__.p + "" + {"0":"d588ac2ad0a38e3c3191","1":"84c679db83b3a6d95bc0","3":"47f097347cecf58effdf","6":"3ce5435311a357abbb8f","17":"28fa4152a04a37e1a331","18":"524734e85de25047a8ba","19":"4ab2b3b486eb40e503a9","20":"7c39ca9f5630699f3e4a","21":"cc0352e3638a676fef4f","22":"e55bc0f8e9f06422975a","23":"a97c3bc2c710c249d558"}[chunkId] + ".js"
/******/ 	}
/******/
...
__webpack_require__(/*! ./modules/boxnow-notice */ "./resources/scripts/admin/modules/boxnow-notice.js");

__webpack_require__(/*! ./modules/pigeon-notice */ "./resources/scripts/admin/modules/pigeon-notice.js");

__webpack_require__(/*! ./modules/generate-label */ "./resources/scripts/admin/modules/generate-label.js");

__webpack_require__(/*! ./modules/impossible-prices */ "./resources/scripts/admin/modules/impossible-prices.js");

__webpack_require__(/*! ./modules/impossible-prices-scan */ "./resources/scripts/admin/modules/impossible-prices-scan.js");
...
if ($('#woo-bg-settings').length) {
	var settingsTab = function settingsTab() {
		return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(3), __webpack_require__.e(23), __webpack_require__.e(21)]).then(__webpack_require__.t.bind(null, /*! ./apps/settings/app.js */ "./resources/scripts/admin/apps/settings/app.js", 7));
	};
...
if ($('#woo-bg-exports').length) {
	var exportTab = function exportTab() {
		return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(3), __webpack_require__.e(6), __webpack_require__.e(20)]).then(__webpack_require__.t.bind(null, /*! ./apps/export/nra/app.js */ "./resources/scripts/admin/apps/export/nra/app.js", 7));
	};
...
if ($('#woo-bg-exports--microinvest').length) {
	var exportTabMicroinvest = function exportTabMicroinvest() {
		return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(3), __webpack_require__.e(6), __webpack_require__.e(22), __webpack_require__.e(19)]).then(__webpack_require__.t.bind(null, /*! ./apps/export/microinvest/app.js */ "./resources/scripts/admin/apps/export/microinvest/app.js", 7));
	};
...
if ($('#woo-bg-exports--invoice-archive').length) {
	var exportTabInvoiceArchive = function exportTabInvoiceArchive() {
		return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(3), __webpack_require__.e(6), __webpack_require__.e(18)]).then(__webpack_require__.t.bind(null, /*! ./apps/export/invoiceArchive/app.js */ "./resources/scripts/admin/apps/export/invoiceArchive/app.js", 7));
	};
...
if ($('#woo-bg-contact-form').length) {
	var helpTab = function helpTab() {
		return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(3), __webpack_require__.e(17)]).then(__webpack_require__.t.bind(null, /*! ./apps/contact-form/app.js */ "./resources/scripts/admin/apps/contact-form/app.js", 7));
	};
...
/***/ "./resources/scripts/admin/modules/boxnow-notice.js":
/*!**********************************************************!*\
  !*** ./resources/scripts/admin/modules/boxnow-notice.js ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./resources/scripts/admin/modules/generate-label.js":
/*!***********************************************************!*\
  !*** ./resources/scripts/admin/modules/generate-label.js ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./resources/scripts/admin/modules/impossible-prices-scan.js":
/*!*******************************************************************!*\
  !*** ./resources/scripts/admin/modules/impossible-prices-scan.js ***!
  \*******************************************************************/
/*! no static exports found */
...
if ($('body').hasClass('woocommerce_woo-bg-impossible-vat-price')) {
	var formatString = function formatString(template, values) {
		var output = template || '';
	...
	var buildRowHtml = function buildRowHtml(row, statusText) {
		var html = '';
	...
	var appendRows = function appendRows(rows) {
		if (!rows || !rows.length) {
			return;
		}
	...
	var updateProblemSummaryCount = function updateProblemSummaryCount() {
		var realRows = $('#woo-bg-results tbody tr').filter(function () {
	...
	var refreshProductRows = function refreshProductRows(productId, currentRows, statusText) {
		var selector = '#woo-bg-results tbody tr[data-product-id="' + String(productId).replace(/"/g, '\\"') + '"]';
		var $existingRows = $(selector);
	...
	var finishScan = function finishScan(message) {
		isRunning = false;
	...
	var fixSingleRow = function fixSingleRow($row, onDone) {
		var productId = $row.data('product-id');
		var priceKey = $row.data('price-key');
		var targetPrice = $row.data('target-price');
		var $statusCell = $row.find('.woo-bg-row-status');
		var $button = $row.find('.woo-bg-fix-row');
	...
	var fixAllSequential = function fixAllSequential(index, stats) {
		if (!isFixingAll) {
			return;
		}

		var $rows = $('#woo-bg-results tbody tr').filter(function () {
	...
	var getAjaxErrorMessage = function getAjaxErrorMessage(jqXHR, fallback) {
		var message = fallback || t('ajaxError', 'AJAX error');
	...
	var i18n = wooBgImpossiblePrices.i18n || {};

	var $startBtn = $('#woo-bg-start-scan');
	var $fixAllBtn = $('#woo-bg-fix-all');
	var $status = $('#woo-bg-scan-status');
	var $progress = $('#woo-bg-progress-bar');
	var $progressNo = $('#woo-bg-progress-text');
	var $tbody = $('#woo-bg-results tbody');
	var $wrap = $('#woo-bg-results-wrap');
	var $summary = $('#woo-bg-results-summary');
	var $fixSummary = $('#woo-bg-fix-summary');
...
/***/ "./resources/scripts/admin/modules/impossible-prices.js":
/*!**************************************************************!*\
  !*** ./resources/scripts/admin/modules/impossible-prices.js ***!
  \**************************************************************/
/*! no static exports found */
...
function findNearestPossibleGross(grossPrice, taxRate, decimals) {
	...
	for (var i = -3; i <= 3; i++) {
		...
		var roundedGross = Number((Math.round(exactGross * minorUnit) / minorUnit).toFixed(decimals));
...
function ensureAnchor($input) {
	...
	if ($variation.length) {
		...
		if (inputName.indexOf('variable_regular_price') === 0 || inputName.indexOf('variable_sale_price') === 0) {
...
function buildNoticeHtml(suggestedValue, fieldKey) {
	return '' + '<div class="woo-bg-impossible-price-notice" data-field-key="' + fieldKey + '">' + '<div class="woo-bg-impossible-price-notice__text">' + '<strong>' + wooBgImpossiblePrices.i18n.warningPrefix + '</strong><br>' + wooBgImpossiblePrices.i18n.suggested + ' <strong>' + suggestedValue + '</strong>' + '</div>' + '<div class="woo-bg-impossible-price-notice__actions">' + '<button type="button" class="button button-primary woo-bg-apply-corrected-price" data-value="' + suggestedValue + '" data-field-key="' + fieldKey + '">' + wooBgImpossiblePrices.i18n.apply + '</button>' + '</div>' + '</div>';
}

function buildSuccessHtml(fieldKey) {
	return '' + '<div class="woo-bg-impossible-price-success" data-field-key="' + fieldKey + '">' + wooBgImpossiblePrices.i18n.success + '</div>';
}
...
function findInputByFieldKey(fieldKey, $origin) {
	...
	var $pool = $variation.length ? $variation.find('input') : $(document).find('#_regular_price, #_sale_price, input[name^="variable_regular_price"], input[name^="variable_sale_price"]');
	var $match = $();
...
/***/ "./resources/scripts/admin/modules/pigeon-notice.js":
/*!**********************************************************!*\
  !*** ./resources/scripts/admin/modules/pigeon-notice.js ***!
  \**********************************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=admin-76388c3d3adb5c6e0ea4.js.map